...
def clone_dependency_analyzer(model_dir: str):
    ...
    if os.path.exists(ready_file):
        print(f"Dependency analyzer already cloned. Re-clone by removing \'{dependency_analyzer_dir}\' and run this script again.")
        return
...
def download(model_dir: str, lang: str) -> int:
    ...
    download_list = [
        ...
        [f'{line_locator_model_base_url}/checkpoint-best-bleu/pytorch_model.bin', 'locator_model.bin'], 
        [f'{generator_model_base_url}/checkpoint-best-bleu/pytorch_model.bin', 'generator_model.bin'],
    ]
