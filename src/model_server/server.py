...
def run_discriminator():
    ...
    if d_tokenizer is None or d_model is None:
...
def run_range():
    ...
    if r_tokenizer is None or r_model is None or r_device is None:
...
def run_content():
    ...
    if c_tokenizer is None or c_model is None or c_device is None:
